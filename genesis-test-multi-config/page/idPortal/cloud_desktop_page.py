...
class Page(BasePage):
    ...
    console_btn_locator = (
    By.XPATH, "/html/body/app-component/cloud-desktop-component/default-layout-component/header-component/div[2]/a")
    dailycheckin_btn_locator = (By.XPATH,
                                '/html/body/app-component/cloud-desktop-component/default-layout-component/div/daily-checkin-floating-component/img')
    ...
    buybeijingNV4jichu_btn_locator = (By.XPATH,
                                      "/html/body/app-component/cloud-desktop-component/default-layout-component/div/div/ul/li/product-card-component/div/div[2]/button")
    buyshanghaiT4jichu_btn_locator = (By.XPATH,
                                      "/html/body/app-component/cloud-desktop-component/default-layout-component/div/div/ul/li[1]/product-card-component/div/div[2]/button")
    buyshanghaiT4gaoji_btn_locator = (By.XPATH,
                                      "/html/body/app-component/cloud-desktop-component/default-layout-component/div/div/ul/li[2]/product-card-component/div/div[2]/button")
    buysuqian3090biaozhun_btn_locator = (By.XPATH,
                                         "/html/body/app-component/cloud-desktop-component/default-layout-component/div/div/ul/li/product-card-component/div/div[2]/button")
